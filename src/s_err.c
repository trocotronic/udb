...
/* 349    RPL_ENDOFEXLIST */ ":%s 349 %s %s :Fin de la lista except",
/* 350 */ NULL,
...
/* 439    ERR_TARGETTOOFAST */ ":%s 439 %s %s :Cambio de mensaje rápido. Espera %d segundos",
...
/* 516 */ NULL,
/* 517 */ NULL,
/* 518    518 */ ":%s 518 %s :No puedes invitar (+V)",
/* 519    519 */ ":%s 519 %s :No puedes entrar (+A)",
/* 520    520 */ ":%s 520 %s :No puedes entrar (+O)",
