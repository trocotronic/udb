...
int x=0;
	...
	{
		config_error("ERROR: set::allowed-nickchars combinaciÛn incorrecta "
	...
	if (x > 1)
	{
		config_status("Advertencia: set::allowed-nickchars: "
...
LangList *l = charsys_find_language(name);
	...
	{
		config_error("set::allowed-nickchars: ERROR: 'euro-west' se llama 'latin1'");
		return 0;
	}
	return 0;
}
